...
/// Note: All string names must match the FontAwesomeIcons name
/// https://github.com/fluttercommunity/font_awesome_flutter/blob/master/lib/font_awesome_flutter.dart
const Map<String, IconData> FaMap = {
